...
class Auth extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->form_validation->set_rules('passoword', 'Password', 'requird|trim');
    ...
    private function _login()
    {
        ...
        if ($user) {
            if ($user['is_active'] == 1) {
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Maaf! Email ini belum aktif </div>');
                redirect('auth');
            }
        } else {
